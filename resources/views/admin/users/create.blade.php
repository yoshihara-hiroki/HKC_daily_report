            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="mb-4">
                            <label for="password_confirmation" class="block text-sm font-medium text-gray-700">パスワード（確認） <span class="text-red-500">*</span></label>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex space-x-6">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="role" value="employee" class="form-radio text-indigo-600" {{ old('role', 'employee') == 'employee' ? 'checked' : '' }}>
                                    <span class="ml-2">一般社員</span>
                                </label>
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="role" value="admin" class="form-radio text-indigo-600" {{ old('role') == 'admin' ? 'checked' : '' }}>
